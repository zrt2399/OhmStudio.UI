...
{
    /// <summary>
    /// Helper methods to assist with drop hints, used through <see cref="DragDropAttach.UseDropTargetHintProperty"/>.
    /// </summary>
    internal static class DropHintHelpers
    {
        ...
        public static void OnDragStart(IDragInfo dragInfo)
        {
            ...
            foreach (var weakReference in visibleTargets)
            {
                ...
                var handler = DragDropAttach.TryGetDropHandler(null, sender);
                if (handler != null)
                {
        ...
        private static void UpdateHintAdorner(DropTargetHintWeakReference weakReference, Type adornerType, DropHintData hintData)
        {
            ...
            if (weakReference.DropTargetHintAdorner == null)
            {
                ...
                var dataTemplate = DragDropAttach.TryGetDropHintDataTemplate(weakReference.Target);
        ...
        {
            return _dropTargetHintReferences.FindAll(m => m.Target?.IsVisible == true && DragDropAttach.GetIsDropTarget(m.Target));
        }
