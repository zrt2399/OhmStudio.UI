...
namespace OhmStudio.UI.Attaches.DragDrop.Utilities
{
    public static class VisualTreeExtensions
    {
        ...
        /// </summary>
        /// <param name="d"></param>
        /// <param name="itemSearchType"></param>
        /// <param name="itemsControl"></param>
        /// <param name="itemContainerSearchType"></param>
        /// <returns></returns>
        ...
        public static DependencyObject GetVisualAncestor(this DependencyObject d, Type itemSearchType, ItemsControl itemsControl, Type itemContainerSearchType)
        {
            ...
            if (itemContainerSearchType == null)
            {
                throw new ArgumentNullException(nameof(itemContainerSearchType));
            }
