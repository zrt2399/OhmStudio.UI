...
namespace OhmStudio.UI.Controls
{
    ...
    public class RunningBlock : ContentControl
    {
        ...
        public static readonly DependencyProperty IsRunningProperty = DependencyProperty.Register(
            nameof(IsRunning), typeof(bool), typeof(RunningBlock), new PropertyMetadata(true, (sender, e) =>
            {
                var runningBlock = (RunningBlock)sender;
        ...
        private void UpdateContent()
        {
            ...
            if (MathHelper.IsZero(_elementPanel.ActualWidth) || MathHelper.IsZero(_elementPanel.ActualHeight))
            {
                return;
            }
